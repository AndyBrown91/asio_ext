    ...
    namespace detail
    {
        ...
        struct sync_wait_cpo
        {
            ...
            constexpr auto operator()(Sender&& sender) const {
                using decayed = std::decay_t<Sender>;
                using value_types = typename asio_ext::sender_traits<decayed>::template value_types<std::tuple, std::variant>;
                return asio_ext::detail::valued_sync_wait_impl<value_types>::run(std::forward<Sender>(sender));
            }
        };
    } // namespace detail
...
struct set_value_member<asio_ext::detail::reference<T>, void(Values...)>
{
...
template <class... Values>
struct set_value_member<asio_ext::detail::reference<void>, void(Values...)>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef void result_type;
...
struct set_error_member<asio_ext::detail::reference<T>, E>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
...
template <typename E>
struct set_error_member<asio_ext::detail::reference<void>, E>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;
...
template <typename T>
struct set_done_member<asio_ext::detail::reference<T>>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;
...
template <>
struct set_done_member<asio_ext::detail::reference<void>>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;
